  ...
  return (
    <div className="dark:bg-green-950 w-full">
      ...
      <div className="mt-2 flex items-center p-1 bg-blue-950 max-w-55 justify-center rounded-2xl gap-1 hover:bg-gray-700">
        ...
        {/* contact Us part */}
      <div className="mt-5 flex flex-col gap-y-2 ml-1">
        <h1 className="text-2xl font-bold ml-[1%]">Contact Us</h1>
        <a href="/"><h2 className="text-lg font-serif font-bold bg-blue-950 p-1 rounded-2xl max-w-60 w-[70%]">Janta Secondary School</h2></a>
